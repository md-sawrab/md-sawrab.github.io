...
Median is the middle value of the dataset in which the dataset is ordered in the ascending or in descending order. It is a measure of central tendency that represents the midpoint of a distribution.
